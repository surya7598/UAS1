...
if( empty( $_SESSION['id_user'] ) ){
	...
	if( isset( $_REQUEST['submit'] )){
		...
		$sql = mysqli_query($koneksi, "INSERT INTO transaksi(no_nota, jenis, paket, nama, alamat, nohp, email, bayar, kembali, total, tanggal, id_user) VALUES('$no_nota', '$jenis', '$paket', '$nama', '$alamat','$nohp','$email', '$bayar', '$kembali', '$total', NOW(), '$id_user')");
...
<form method="post" action="" class="form-horizontal" role="form">
	...
	<div class="form-group">
		...
		<div class="col-sm-3">
			<input type="text" class="form-control" id="paket" name="paket" value="" required readonly>
		</div>
	</div>
	<div class="form-group">
